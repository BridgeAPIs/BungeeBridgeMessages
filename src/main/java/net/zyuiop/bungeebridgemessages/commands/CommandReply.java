package net.zyuiop.bungeebridgemessages.commands;
...
import net.zyuiop.bungeebridgemessages.BungeeBridgeMessagesPlugin;
...
public class CommandReply extends DefaultExecutor {
	...
	public CommandReply(BungeeBridgeMessagesPlugin plugin) {
